...
echo "2. Run optimization: python promptevolver.py"
echo "3. View results: python promptevolver.py --view-iteration 1"
echo ""
echo "For more options, run: python promptevolver.py --help"
